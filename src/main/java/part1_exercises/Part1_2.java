...
public class Part1_2 {
    public static void main(String[] args) throws IOException 
    {
        ...
        //This line of code is printing out the longest string in the array
        System.out.println("The longest string in the array is: " + utils.ExerciseUtilities.findLongest(fileText));
    }
